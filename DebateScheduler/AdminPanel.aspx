<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="DebateScheduler.AdminPanel" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div id ="NewsCreator">
        <asp:Panel ID="Panel_CreateNews" runat="server" BackColor="#CCCCCC" BorderStyle="Solid">
            ...
            <br />
            <FTB:FreeTextBox id="FreeTextBox1" runat="server" EnableHtmlMode="True" Width="488px" />
    ...
    <asp:Panel ID="Panel_CreateReferee" runat="server" BackColor="#CCCCCC" DefaultButton="Button_RefereeMaker" BorderStyle="Solid">
